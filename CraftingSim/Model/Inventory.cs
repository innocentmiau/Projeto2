...
namespace CraftingSim.Model
{
    ...
    public class Inventory
    {
        ...
        {
            //TODO Implement Me
            if (materials.TryAdd(material, quantity)) return;
        ...
        public void LoadMaterialsFromFile(string file)
        {
            ...
            /*
            foreach (IMaterial material in materials.Keys)
            {
                Console.WriteLine($"{material.Name} ({material.Id}): {materials[material]}");
            }
            */
        }
    }
